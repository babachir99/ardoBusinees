                ...
                {product.boostStatus === "PENDING" && (
                  <>
                    <button
                      ...
                      className="rounded-full border border-emerald-300/50 px-4 py-2 text-[11px] text-emerald-200 transition hover:border-emerald-300/80"
                    >
                    ...
                    <button
                      ...
                      className="rounded-full border border-rose-300/40 px-4 py-2 text-[11px] text-rose-200 transition hover:border-rose-300/70"
                    >
