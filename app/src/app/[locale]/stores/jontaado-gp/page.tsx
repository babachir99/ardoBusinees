...
export default async function GpPage() {
  const t = await getTranslations("Verticals.gp");
  ...
  return (
    <div className="min-h-screen bg-jonta text-zinc-100">
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 pb-24">
        <section className="rounded-3xl border border-white/10 bg-gradient-to-br from-violet-300/15 via-zinc-900 to-zinc-900 p-10 card-glow fade-up">
