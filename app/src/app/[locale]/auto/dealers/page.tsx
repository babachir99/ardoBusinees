      ...
      <main className="mx-auto flex w-full max-w-5xl flex-col gap-6">
        <section className="rounded-3xl border border-white/10 bg-gradient-to-br from-cyan-300/15 via-zinc-900 to-zinc-900 p-8">
          ...
          <div className="mt-4 flex gap-2">
            <Link href="/auto" className="rounded-full border border-white/20 px-3 py-1 text-xs font-semibold text-white">
              {t.back}
            </Link>
          </div>
        </section>
          ...
          {dealers.length === 0 ? (
            ...
            dealers.map((dealer) => (
              <article key={dealer.id} className="rounded-2xl border border-white/10 bg-zinc-900/70 p-5">
                ...
                <div className="mt-4">
                  <Link href={`/auto/dealers/${dealer.slug}`} className="rounded-full border border-white/20 px-3 py-1 text-xs font-semibold text-white">
                    {t.view}
                  </Link>
                </div>
              </article>
